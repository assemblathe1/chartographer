Для запроса POST /chartas/{id}/?x={x}&y={y}&width={width}&height={height} в условиях задачи явным образом не указаны параметры width и height,
поэтому будем считать их равными максимальным размерам папмруса (20000*50000)
